...
PARAMS = {
    ...
    'window_size' : 3,              # Window Size for Input
    'input_shape' : (16, 22, 1),    # Input Shape is (4 + (w*4), 22, 1) where w is the window size
    'lr' : 0.001,
    'actions' : [
        Action.MATCH.value, 
