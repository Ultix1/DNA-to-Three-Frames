...
class Environment:
    def __init__(self, window_size=3):
        ...
        # Initial Pointers
        self.dna_pointer = window_size * 3
        self.protein_pointer = window_size
        self.dna_len = 0
        self.protein_len = 0
    ...
    def pad_sequences(self):
        ...
        if(len(self.dna_sequence) > 0 and len(self.protein_sequence) > 0):
            ...
            # '0000' + DNA + Pad
            self.dna_sequence = ''.join("0000", self.dna_sequence, dna_pad)

            # '*' + Protein + Pad
            self.protein_sequence = ''.join("*", self.protein_sequence, protein_pad)
    ...
    def reset(self):
        ...
        """
        # Reset Pointers
        self.dna_pointer = 4        # Accounting for padding on the left (0000)
        self.protein_pointer = 1    # Accounting for padding on the left (*)
